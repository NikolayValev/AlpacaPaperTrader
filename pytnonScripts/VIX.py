...
Data = fetch_data("NICK/CME_SP1", "", "2017-07-31", "local_future.csv")
Data1 = fetch_data("NICK/SPX_PC", "", "2017-07-31", "local_data.csv")
...
# c_1 is the value above which the sell order wi;; execute in a successful trade
c_1 = (1 + (change_1)/float(100))
# c_2 is the value below a sell order will execute in a stoploss
c_2 = (1 - (change_2)/float(100))
...
Data['cost'] = - (Data['placed_order'].multiply(Data['future'])
                  ) * 500 * 2  # Cost of each transaction
# Out is the cumulative cost profit / loss after transaction till now
